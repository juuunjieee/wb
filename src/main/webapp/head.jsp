...
<script type="text/javascript">
  var _global_token="<%=session.getAttribute("token")%>";
</script>
<script type="text/javascript"
...
<script type="text/javascript"
	src="<%=request.getContextPath()%>/js/jquery.plug/jquery.populate.js"></script> 
...
<script type="text/javascript" src="<%=request.getContextPath()%>/js/jquery.easyui.ext/jquery.easyui.form.ext.js"></script> 
<script type="text/javascript"
