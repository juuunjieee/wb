...
<script>
	...
	function initform(){
	    ...
	    $("input[name='originPw']:radio").click(function(){
	    	if($(this).val()=='true'){
				$("#password").textbox("setValue","jyd2018100.com");
		    	$("#confirmPassword").textbox("setValue","jyd2018100.com");	
		...
		<div class="commonForm-items">
			...
			<div class="form-item__content">
				<label>是:<input checked="checked" value="true" type="radio"
					...
					name="originPw" /></label> <label style="color: red">(初始密码为:jyd2018100.com)</label>
			</div>
		</div>
		<div class="commonForm-items">
			<input 
